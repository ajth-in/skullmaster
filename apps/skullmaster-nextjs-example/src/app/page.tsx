  ...
  return (
    <section className="border-[3px] border-black bg-lime-300 p-8" {...markAsSkull("Hero")}>
      <div className="flex flex-col gap-2">
        <span className="w-fit border-[3px] border-black bg-black px-3 py-1 text-xs font-black uppercase tracking-widest text-white">
          Sample demo · not a real app
        </span>
        ...
        <p className="max-w-xl text-black/80">
          Every component, image and control on this page is sample test content used to demo a
          generated skeleton. Toggle the button to see the loaders swap in.
        </p>
...
function ComponentsShowcase() {
  return (
    <section className="mt-8" {...markAsSkull("Components", { isTransparent: true })}>
      <h2 className="mb-4 text-2xl font-black">Sample Components</h2>
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <div className="border-[3px] border-black bg-white p-4">
          ...
          <div className="flex flex-col gap-2">
            <div className="border-2 border-black bg-yellow-300 px-3 py-2 text-sm font-bold">
              ⚠️ Two sample alerts stacked vertically.
            </div>
            <div className="border-2 border-black bg-lime-300 px-3 py-2 text-sm font-bold">
              ✅ More placeholder content for the demo.
            </div>
          </div>
        </div>
        ...
        <div className="border-[3px] border-black bg-white p-4">
          ...
          <progress
            ...
            max={100}
          />
          <p className="mt-2 text-sm font-bold">75% of this demo is sample content</p>
        </div>
  ...
  if (isLoading) {
    return (
      <section className="mt-8">
        <h2 className="mb-4 text-2xl font-black">Sample Image Gallery</h2>
        <div className="grid gap-4 sm:grid-cols-2">
          {IMAGES.map((img) => (
  ...
  return (
    <section className="mt-8">
      ...
      <p className="mb-4 text-sm font-semibold text-black/60">
        Random placeholder photos, used only to demo skeletons for image content.
      </p>
      <div className="grid gap-4 sm:grid-cols-2">
        {IMAGES.map((img) => (
          <div
  ...
  return (
    <main className="mx-auto max-w-5xl px-4 py-16">
      ...
      <footer className="mt-12 border-t-[3px] border-black pt-4 text-sm font-bold">
        <p>
          Sample demo app for <strong>Skullmaster</strong> &bull; Built with Next.js + Tailwind CSS
        </p>
      </footer>
    </main>
  );
